...
import meshgeometry.*;
import meshtopology.TopologyCartesianMesh;
 ...
 *
 */
public class GenerateCartesianMesh {
	...
	public void process() throws IOException {
		...
		if (step == 0) {
			...
			TopologyCartesianMesh topology = new TopologyCartesianMesh();
			...
			topology.set(verticesCoordinates, elementsVertices, borderEdgesVertices, borderEdgesLabel, true);
